...
Under 8~C.F.R.\ §\,204.5(h)(4), when a criterion in §\,204.5(h)(3) (such as “artistic exhibitions or showcases”) does not directly apply to the occupation, USCIS may consider \emph{comparable evidence}.IT project management work is not typically displayed in artistic exhibitions. Instead an IT professional publicly displays project methods and roadmaps at scholarly conferences. This presentation also includes architectures and implementation case studies and technical papers. These works are then archived in citable proceedings or repositories. The materials below therefore show evidence of equivalent significance.



\underline{Participation in conference “Digitalization and Technological Revolutions Current Challenges and Opportunities” (Omega Science) 12 Jul 2025.}
...
The International Centre for Innovative Research “Omega Science” hosted the event and issued the proceedings as a citable book series. University libraries list those volumes for academic reference.
...
\underline{Participatoin in LXXXIII International Scientific Practical Conference “World Science Problems and Innovations” 30 May 2025}
The work includes the paper \emph{“Algorithm for developing post quantum cryptography to protect critical infrastructure \textnormal{against} quantum attacks (LatticeCI)”}.
...
\underline{Participation in conference “Modern Technologies Technical and Natural Sciences” 5 Jun 2025.}
At the conference, A. Taximov demonstrated the work “Optimization of cloud system performance using adaptive machine learning algorithms” that looks at ways Machine Learning helps cloud computer systems work faster and stay stable.
...
\underline{Participation in XLIII All Russian Scientific Practical Conference “Modern Methods and Innovations in Science” May~2025.}
The work includes the Paper \emph{“Mechanism of accelerated technology transfer from scientific laboratories to industry of Kazakhstan (TTEP)”}.
The proceedings state materials are \emph{selected scientific works} recommended by the Editorial Publishing Council (protocol and date). This paper showcases a scheme for a national platform named TTEP that links scientific laboratories with private firms. The aim is to convert research inventions into market ready goods at a faster pace through a digital market for patents. The scheme forecasts a rise of twenty to thirty percent in successful technology launches within three years and gives priority to the launch of green technologies.
...
\underline{Participation in LXXXV International Scientific Practical Conference series “Scientific Forum Innovative Science” Issue~6(85), 2025.}
...
\underline{Participation in conference “Profit Smart City Day 2024” 11 Oct 2024.}
...
\underline{Participation in Digital Festival \“Google Dev Fest Taraz 2023” 16-17 Nov 2023.}
...
Across these items, Mr.~Taximov’s \emph{own work product} was publicly presented and archived in curated conference proceedings. Since artistic exhibitions do not readily apply to STEM product or program leadership, these conferences are \emph{comparable in significance} under 8~C.F.R.\ §\,204.5(h)(4).

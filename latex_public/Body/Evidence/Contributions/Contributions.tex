...
\noindent\underline{iKOMEK109 Development Director (CRM, NextITSM and election data).} iKOMEK109's Development Director (Director of the Development Department) Anuar Beisenbayev focuses on \mrl{} as the IT project owner for the new omnichannel CRM platform and election-related data engineering. He writes that \mrl{} authored the technical architecture and led the engineering team:
...
Mr. Beisenbayev notes that \mrl{} specified and launched online services. He also built Telegram bots. Citizens used these tools to find their polling stations. This work proves his ability to manage a full project. He controlled the process from the internal algorithms to the user screens. \ExhibitRef{BeisenbaevLetter}

...
\begin{enumerate}
    \item Summary of Mr. Taximov’s achievements and qualifications

    \item \mrl satisfies \underline{nine} of the ten criteria listed in 8
    ...
    \begin{enumerate}[label=\roman*)]
        ...
        \item Evidence of published material about \mrl\ in professional or major media relating 
        to his work \SectionRef{subsec:Published}.
        % 4
        \item Evidence that \mrl has been asked to judge the work of others on a panel
        \SectionRef{subsec:Judging}.
        % 5
        \item Evidence of \mrls original scientific, business-related contributions of major significance
        to the field \SectionRef{subsec:Contributions}.

        \item Evidence of \mrls authorship of scholarly articles in the field, in professional or major trade publications or other major media
        \SectionRef{subsec:Articles}

        \item Comparable evidence of public display of work (IT Project Management)
        \SectionRef{subsec:Display}
        % 8

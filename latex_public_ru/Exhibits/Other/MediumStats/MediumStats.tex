\Exhibit{MediumStats}{%
    Статистика всех технических статей Алексея Инкина на Medium%
}

Скриншоты приватных страниц статистики, подтверждающие данные для каждой статьи, приведены в:

\begin{itemize}[nosep]
    \item Статья, получившая буст -- \ExhibitRef{SignInRoutesStats}.
    \item Статьи, отобранные по старой программе -- \ExhibitRef{MediumStatsDistributed}.
    \item Прочие статьи -- \ExhibitRef{MediumStatsRegular}.
\end{itemize}
